...
const activeLink = "bg-gray-100 dark:bg-gray-600";
        ...
        <div className="h-screen w-72">
          <div className="flex items-center justify-start mx-6 mt-10">
            <Link to={"/"}>
              ...
              <span className="text-gray-600 dark:text-gray-300 ml-4 text-2xl font-bold">Coupo</span>
            </Link>
          </div>
          <nav className="mt-10 px-6 ">
            <Link
              className={` ${
                location.pathname === "/admin" ? activeLink : ""
              } hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-800 dark:text-gray-100 rounded-lg`}
              to="/admin"
            >
              <svg
              ...
              <span className="mx-4 text-lg font-normal">Add Coupon</span>
              <span className="flex-grow text-right"></span>
            </Link>
            <Link
              className={`${
                location.pathname === "/admin/addBrand" ? activeLink : ""
              } hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-800 dark:text-gray-100 rounded-lg`}
              to="/admin/addBrand"
            >
              <svg
              ...
              <span className="mx-4 text-lg font-normal">Add Brand</span>
              <span className="flex-grow text-right"></span>
            </Link>
          </nav>
